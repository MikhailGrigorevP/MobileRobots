#include "pch.h"
#include "../MobileRobots/environmentDescriptor.cpp"
#include "../MobileRobots/environmentDescriptor.h"
#include "../MobileRobots/Component.h"
#include "../MobileRobots/Component.cpp"
#include "../MobileRobots/Module.h"
#include "../MobileRobots/Module.cpp"
#include "../MobileRobots/structures.h"
...
TEST(ComponentT, C_management_info) {
	...
	std::vector<Point> points = { { 2,1 }, { 2,4 }, {7,3} };
